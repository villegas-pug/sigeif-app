...
@Service
@AllArgsConstructor
public class GenerateEncuestaSatisfaccionUseCaseImpl extends BaseReportingService
      implements GenerateEncuestaSatisfaccionUseCase {

   private final EncuestaSatisfaccionProperties properties;
   private final BaseRepository repository;

   @Override
   public void generateEncuestaSatisfaccionReport() throws IOException {

      // * 1. Ejecutar procedimiento almacenado
      Map<String, Object> inParams = new HashMap<>();
      inParams.put("p_id_Servicio", InabifServices.PUNCHE.getId());
      inParams.put("p_num_anexo", PuncheFichas.CUESTIONARIO_SATISFACCION.getId());
