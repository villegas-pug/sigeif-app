...
@Repository
public class CodigoFamiliaRepositoryAdapter extends BaseOracleRepository implements CodigoFamiliaRepositoryPort {

   public CodigoFamiliaRepositoryAdapter(JdbcTemplate jdbcTemplate, DataSource dataSource) {
