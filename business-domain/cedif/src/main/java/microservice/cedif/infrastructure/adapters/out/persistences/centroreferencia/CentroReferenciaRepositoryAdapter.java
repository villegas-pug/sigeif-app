package microservice.cedif.infrastructure.adapters.out.persistences.centroreferencia;
...
@AllArgsConstructor
@Log4j2
public class CentroReferenciaRepositoryAdapter implements CentroReferenciaRepositoryPort {
   ...
   public void saveCentrolReferencia(int tipoReferencia, CentroReferenciaCreateCommand centroRefDto) {
      ...
      final String TIPO_REF_PARAM = "p_tipo_ref";
      ...
      try (OracleConnection conn = dataSource.getConnection().unwrap(OracleConnection.class)) {
         ...
         Map<String, Object> inParams = new HashMap<>();
         inParams.put(TIPO_REF_PARAM, tipoReferencia);
